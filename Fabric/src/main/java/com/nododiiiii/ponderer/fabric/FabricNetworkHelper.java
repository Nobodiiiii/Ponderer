...
public class FabricNetworkHelper implements NetworkHelper {
    ...
    private static final ResourceLocation PROJECTOR_PLAYBACK_START = new ResourceLocation(Ponderer.MODID, "projector_playback_start");
    ...
    private void registerClientboundHandlers() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(PROJECTOR_PLAYBACK_START, (client, handler, buf, responseSender) -> {
            ProjectorPlaybackStartPayload msg = ProjectorPlaybackStartPayload.decode(buf);
            client.execute(() -> ProjectorPlaybackStartPayload.handle(msg));
        });
    ...
    private ResourceLocation getChannelId(Object packet) {
        ...
        if (packet instanceof ProjectorPlaybackStartPayload) return PROJECTOR_PLAYBACK_START;
    ...
    private void encodePacket(Object packet, net.minecraft.network.FriendlyByteBuf buf) {
        ...
        else if (packet instanceof ProjectorPlaybackStartPayload p) p.encode(buf);
