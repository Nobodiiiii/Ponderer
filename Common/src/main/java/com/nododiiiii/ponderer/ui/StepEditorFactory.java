...
public final class StepEditorFactory {
    ...
    public static AbstractStepEditorScreen createAddScreen(String type, DslScene scene, int sceneIndex,
        ...
        return switch (type.toLowerCase(Locale.ROOT)) {
            ...
            case "hide_section" -> new SelectionOperationScreen("hide_section", true, false, true, scene, sceneIndex, parent);
            case "show_section_and_merge" -> new SelectionOperationScreen("show_section_and_merge", true, true, true, scene, sceneIndex, parent);
    ...
    public static AbstractStepEditorScreen createEditScreen(DslScene.DslStep step, int stepIndex,
        ...
        return switch (step.type.toLowerCase(Locale.ROOT)) {
            ...
            case "hide_section" -> new SelectionOperationScreen("hide_section", true, false, true, scene, sceneIndex, parent, stepIndex, step);
            case "show_section_and_merge" -> new SelectionOperationScreen("show_section_and_merge", true, true, true, scene, sceneIndex, parent, stepIndex, step);
