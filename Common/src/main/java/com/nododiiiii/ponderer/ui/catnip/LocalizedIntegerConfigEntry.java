...
public class LocalizedIntegerConfigEntry extends PlainTextListEntry {
    ...
    public LocalizedIntegerConfigEntry(String labelKey, @Nullable String hintKey, @Nullable String tooltipKey,
                                       ModConfigSpec.ConfigValue<Integer> value, ModConfigSpec.ValueSpec spec) {
    ...
    private void applyValue(String rawValue, ModConfigSpec.ConfigValue<Integer> value,
                            ModConfigSpec.ValueSpec spec, ConfigEntrySupport.Metadata metadata) {
        try {
