 ...
 * NeoForge: DeferredRegister + DeferredHolder. Fabric: Registry.register().
 */
public interface RegistrationHelper {
    ...
    /** Perform post-registration setup (e.g., register the DeferredRegister to the mod bus on NeoForge). */
    void init();
}
